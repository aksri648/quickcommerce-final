...
const ConfigSchema = z.object({
  ...
  NEON_AUTH_BASE_URL: z.string().default('https://ep-blue-lake-ayu8hucy.neonauth.c-5.us-east-2.aws.neon.tech/neondb/auth'),
  NEON_AUTH_JWKS_URL: z.string().default('https://ep-blue-lake-ayu8hucy.neonauth.c-5.us-east-2.aws.neon.tech/neondb/auth/.well-known/jwks.json'),
